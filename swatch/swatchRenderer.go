...
// The size parameter in it is provided to us by fyne when it calculates the layout of the application,
// essentially it's the ammount of space we have available to draw a swatch
